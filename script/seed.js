...
async function seed() {
  ...
  const species = await Promise.all([
    Species.create({
      ...
      category: 'Bird',
      kingdom: 'Animal',
      description: `The bald eagle (Haliaeetus leucocephalus) is a bird of prey found in North America. A sea eagle, it has two known subspecies and forms a species pair with the white-tailed eagle (Haliaeetus albicilla). Its range includes most of Canada and Alaska, all of the contiguous United States, and northern Mexico. It is found near large bodies of open water with an abundant food supply and old-growth trees for nesting.`,
      diet: 'Everything',
    ...
    Species.create({
      ...
      kingdom: 'Plant',
      description: `The American chestnut (Castanea dentata) is a large, monoecious deciduous tree of the beech family native to eastern North America.[2] The American chestnut was once considered one of the most important forest trees throughout its range and was considered the finest chestnut tree in the world.[3][4] However, the species was devastated by chestnut blight, a fungal disease that came from introduced chestnut trees from East Asia. It is estimated that between 3 and 4 billion American chestnut trees were destroyed in the first half of the 20th century by blight after its initial discovery in 1904.[5][6][7] Very few mature specimens of the tree exist within its historical range, although many small shoots of the former live trees remain.`,
    ...
    Species.create({
      ...
      kingdom: 'Fungus',
      description: `Cerrena unicolor, commonly known as the mossy maze polypore,[1] is a species of poroid fungus in the genus Cerrena (Family: Polyporaceae). This saprobic fungus causes white rot.`,
      diet: 'Plants',
    ...
    Species.create({
      ...
      kingdom: 'Animal',
      description: `The thirteen-segment larvae are usually covered with brown hair in their mid-regions and black hair in their anterior and posterior areas. In direct sunlight, the brown hair looks bright reddish brown.`,
      diet: 'Everything',
      habitat: 'North America',
      isEndangered: false,
      imageUrl:
